...
const _exports = {
  ...
  // Federated Threat Intelligence — consolidated into threat-intel-network.js in v15
  ...
  // v12.0 — Federated Threat Intelligence (ThreatIntelNode consolidated in v15 → use ThreatIntelNetwork)
