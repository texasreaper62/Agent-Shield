...
const PRESETS = {
  ...
  strict: {
    ...
    enabledCategories: ['prompt_injection', 'data_exfiltration', 'tool_abuse', 'jailbreak', 'social_engineering', 'encoding_attack'],
    rateLimiting: false,
    auditTrail: true,
    piiRedaction: false,
    shadowMode: false
  ...
  paranoid: {
    ...
    blockSeverity: 'low',
    enabledCategories: ['prompt_injection', 'data_exfiltration', 'tool_abuse', 'jailbreak', 'social_engineering', 'encoding_attack', 'reconnaissance', 'privilege_escalation'],
    rateLimiting: true,
    auditTrail: true,
    piiRedaction: true,
    shadowMode: false
  ...
  compliance: {
    ...
    blockSeverity: 'high',
    enabledCategories: ['prompt_injection', 'data_exfiltration', 'tool_abuse', 'jailbreak'],
    rateLimiting: false,
    auditTrail: true,
    piiRedaction: true,
    shadowMode: false
